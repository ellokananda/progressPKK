...
class Bimbelp extends Component {
  constructor() {
  ...
  // memanggil API untuk mendapatkan data dari database
    ...
    let url = "http://localhost/projek_ukk/public/bimbelp";
    // menampilkan file untuk dijalankan
    axios.get(url) // untuk mengirim data
    .then(response => {
      this.setState({bimbelp: response.data.bimbelp});
  ...
  Drop = (id) => { // fungsi untuk menghapus data
      ...
      // menampilkan pesan konfirmasi
        $("#loading").toast("show");
        // menampilkan proses loading
        let url = "http://localhost/projek_ukk/public/bimbelp/drop/"+id;
  ...
  Save = (event) => { // fungsi untuk menyimpan data
    ...
    $("#loading").toast("show");
    //menutup form modal
    $("#modal_bimbelp").modal("hide");
    let url = "http://localhost/projek_ukk/public/bimbelp/save";
    // memanggil file untuk dijalankan
        ...
        <div className="container">
          <div className="card mt-2">
            ...
            <div className="card-body">
              ...
              {/* form modal siswa*/}
              <Modal id="modal_bimbelp" title="Form Tambah" bg_header="info" text_header="white">
