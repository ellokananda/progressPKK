...
class Bimbels extends Component {
  ...
  // fungsi yg pertama kali dijalankan
    ...
    this.state = {
      ...
      bimbels: [
        {id_bimbel: "001", nama_bimbel: "Elli Community", alamat_bimbel: "Jakarta", biaya: 12000, nomor: "09828"},
        {id_bimbel: "001", nama_bimbel: "Eden Course", alamat_bimbel: "Surabaya", biaya: 12000000, nomor: "087535671208"}
      ],
      id_bimbel: "",
      id_daftar: "",
      nama_bimbel: "",
        ...
        <div className="container">
          <div className="card mt-2">
            ...
            <div className="card-body">
              ...
              {/* form modal siswa*/}
              <Modal id="modal_bimbels" title="Form Tambah" bg_header="info" text_header="white">
