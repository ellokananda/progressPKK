      ...
      <div className="container" style={{width: "35%"}}>
        <div className="card my-5">
          <div className="card-header bg-dark">
            <h5 className="text-white text-center">Register Admin</h5>
          </div>
          <div className="card-body bg-danger">
            <Toast id="message" autohide="false" title="informasi">
            {this.state.message}
            </Toast>
            <form onSubmit={this.Registera}>
            <span>
            ...
            <div className="d-flex justify-content-center text-black">
              <p class="text-dark">Sudah punya akun? <a href="#" class="text-warning border-warning border-bottom"> Login Disini!</a></p>
            </div>
              </form>
            </div>
          </div>
